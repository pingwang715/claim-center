...
public interface IClaimService {
    ...
    ClaimDetailDto getClaimDetail(Long id, User user) throws AccessDeniedException;
    ClaimDetailDto createClaim(CreateClaimRequestDto createClaimRequestDto, User user) throws AccessDeniedException;
    ...
    ClaimDetailDto approveClaim(Long id, User user) throws AccessDeniedException;
    ClaimDetailDto rejectClaim(Long id, User user) throws AccessDeniedException;
